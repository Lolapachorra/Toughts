...
module.exports = class ToughtController {
  static async showToughts(req, res) {
    ...
    const toughtsData = await Tought.findAll({include: User, where: {
  ...
  static async removeTought(req, res){
   ...
   try {
     ...
     req.flash("message", "Ocorreu um erro ao tentar remover a Tought, tente novamente!")
     res.redirect("/toughts/dashboard")
   }
  ...
  static async updateToughtPost(req, res) {
   ...
   try {
     ...
     console.error(error.message)
     req.flash("message", "Ocorreu um erro ao tentar atualizar a Tought, tente novamente!")
